...
#[test]
fn to_str() {
    assert_eq!("Neutral", PlayerTeam::Neutral.to_str());
...
#[test]
fn from_str() {
    assert_eq!(PlayerTeam::Neutral, PlayerTeam::from_str("Neutral").unwrap());
...
#[test]
fn serialize() {
    assert_eq!("\"Neutral\"", serde_json::to_string(&PlayerTeam::Neutral).unwrap());
...
#[test]
fn deserialize() {
    assert_eq!(PlayerTeam::Neutral, serde_json::from_str("\"Neutral\"").unwrap());
